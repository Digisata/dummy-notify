...
Future<void> main() async {
  ...
  OneSignal.shared.setPermissionObserver((OSPermissionStateChanges changes) {
    ...
    print("OneSignal: permission changes: ${changes?.jsonRepresentation()}");
  });
  ...
  OneSignal.shared
    ...
    print("OneSignal: subscription changes: ${changes?.jsonRepresentation()}");
  });
  ...
  OneSignal.shared.setEmailSubscriptionObserver(
    ...
    print(
        "OneSignal: email subscription changes: ${emailChanges?.jsonRepresentation()}");
  });
